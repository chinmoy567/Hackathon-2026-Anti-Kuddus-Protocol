...
export const Desk = ({ seatRow, seatCol, studentId, studentLookup, isTeacherSeat }) => {
  ...
  return (
    <div className="relative">
      ...
      >
        {student ? (
          <>
            <span className="font-medium text-slate-900">#{student.rollNumber}</span>
      ...
      {open && student && (
        <div
          role="tooltip"
          className="absolute left-1/2 top-full z-10 mt-2 w-44 -translate-x-1/2 rounded-xl border border-slate-200
